...
export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      { title: "Marcellina Event Center — Timeless Venue for Weddings & Galas" },
      { name: "description", content: "An award-winning event center hosting weddings, galas, and milestone celebrations with quiet luxury and impeccable service." },
      { property: "og:title", content: "Marcellina Event Center" },
      { property: "og:description", content: "Where milestones become memories. A timeless venue crafted with quiet luxury." },
