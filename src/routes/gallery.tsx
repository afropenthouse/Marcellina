...
export const Route = createFileRoute("/gallery")({
  head: () => ({
    meta: [
      { title: "Gallery — Marcellina Event Center" },
      { name: "description", content: "A visual journal of weddings, galas, and intimate dinners hosted at Marcellina Event Center." },
      { property: "og:title", content: "Gallery — Marcellina Event Center" },
      { property: "og:description", content: "A visual journal of celebrations crafted at Marcellina." },
      ...
      <section className="pt-40 pb-20 px-6 bg-gradient-radial">
        <div className="mx-auto max-w-5xl text-center">
          ...
          <p className="mt-8 text-lg text-muted-foreground max-w-2xl mx-auto leading-relaxed">
            ...
            quiet details that linger long after the night ends.
          </p>
        </div>
      </section>
