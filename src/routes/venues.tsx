...
export const Route = createFileRoute("/venues")({
  head: () => ({
    meta: [
      { title: "Venues — Marcellina Event Center" },
      { name: "description", content: "Tour our four signature event spaces — from the open-air Rose Garden to the candlelit Atelier — designed for weddings, galas, and milestone events." },
      { property: "og:title", content: "Venues — Marcellina Event Center" },
      { property: "og:description", content: "Four signature spaces designed for weddings, galas, and milestone events." },
      { property: "og:image", content: gardenImg },
    ],
  }),
